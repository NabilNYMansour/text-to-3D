      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/wrapper flex min-h-svh w-full has-[[data-variant=inset]]:bg-sidebar",
              className
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-[--width] flex-col bg-sidebar text-foreground",
            className
          )}
          ref={ref}
          {...props}
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--width] bg-sidebar p-0 text-foreground [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 relative h-svh w-[--width] bg-transparent transition-[width] ease-linear",
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-svh w-[--width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
